...
<Jumbotron>
  ...
  <H1 style={{ color: 'black' }}>Redocly training</H1>
  ...
  <Flex p={20} justifyContent="center">
    {/* <Button size="xlarge" to="https://app.redoc.ly">
     ...
     <Button variant="outlined" size="xlarge" to="developer-portal/welcome.mdx">
      Get started
    </Button>
...
<Box my={25}>
  ...
  <script>
  {/* (function () {
  setTimeout(() => document.querySelector('#gatsby-focus-wrapper').style.filter = 'grayscale(100%)', 1000)
})(); */}
